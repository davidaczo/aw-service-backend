...
export class addOTPCodes1764165557601 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_9e85e1945c47dfb71042ae5d19" ON "otp_codes" ("email") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_8d0e7e090f046cc9bc5a6e54a6" ON "otp_codes" ("email", "createdAt") `,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8d0e7e090f046cc9bc5a6e54a6"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9e85e1945c47dfb71042ae5d19"`,
    );
